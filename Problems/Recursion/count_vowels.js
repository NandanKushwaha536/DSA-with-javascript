...
function recursiveCountVowels(string, stringLength){
    console.log(`Length: ${stringLength} , 
        current String ${string.substring(0, stringLength)}`)
        ...
        // return recursiveCountVowels (string, stringLength-1 )
        //  + isVowel(string[stringLength - 1])

        let result = recursiveCountVowels(string, stringLength - 1) + isVowel
